        ...
        >
          <Button
            onClick={() => {
              ...
              // Show golden message after 2 seconds
              setTimeout(() => {
          ...
          >
            ...
            >
              ...
              <div className="text-white text-sm leading-relaxed space-y-2">
                <p>
                  sorry, I'm not really a big fan of
                  touching others…
                </p>
                <p>
                  but I do like being touched or caressed.
                </p>
                <div className="pt-2 border-t border-[#FF66CC]/20">
                  <p className="text-gray-300 text-xs italic">
                    still — non-sensual full-body massage
                    only
                  </p>
                </div>
              </div>
